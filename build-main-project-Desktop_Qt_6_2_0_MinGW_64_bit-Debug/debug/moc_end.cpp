...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_end_t, stringdata0) + ofs), len 
...
const QMetaObject end::staticMetaObject = { {
    ...
    qt_meta_stringdata_end.offsetsAndSize,
    qt_meta_data_end,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_end_t
